import {
  ...
  const Freshvegetable = ({navigation}) => {
    const data = [
      ...
      { id: '3', imageUrl: require("../assets/PopularProduct/p8.jpg"), title: 'Item 1',name:"Orange",price:"300TK",weight:"1kg" },
      { id: '4', imageUrl: require("../assets/FlashSales/f10.jpg"), title: 'Item 2' ,name:"Watermelon",price:"620TK",weight:"2kg"},
      { id: '5', imageUrl:require("../assets/Freshfood/2.jpg"), title: 'Item 2',name:"Apple",price:"320TK",weight:"2kg" },
      { id: '6', imageUrl: require("../assets/PopularProduct/p10.jpg"), title: 'Item 1',name:"Orange",price:"300TK",weight:"1kg" },
